...
def shape_iou(
    ...
    Args:
        ...
        box2 (torch.Tensor): Ground truth bounding boxes, last dim is 4.
        xywh (bool): If True, input format is (x, y, w, h); else (x1, y1, x2, y2).
        scale (float): Scale factor controlling shape weight sensitivity. Default 0 (uniform weights).
            Recommended values based on dataset: 0 for general, small values for small targets.
    ...
    # ========== Shape-Distance ==========
    # Shape weights based on GT box (box2) shape and scale
    ...
    # Shape-weighted center distance (distance^shape)
